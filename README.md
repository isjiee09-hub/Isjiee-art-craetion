...
cp .env.example .env       { "page":"index", "data": { "site-title":"<b>ISJIEE</b>" } }<script>
  // pointeur vers ton API locale (change en production)
  window.ISJ_API_BASE = 'http://localhost:4000';
</script> # crée ton .env local à partir de l'exemple
